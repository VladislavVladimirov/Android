...
class NewEventFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.onlineOrOffline.isChecked = binding.onlineOrOffline.text == getString(R.string.Online)
                ...
                return when (menuItem.itemId) {
                    R.id.save -> {
                        ...
                        if (binding.edit.text.isNotBlank()) {
                            viewModel.changeContent(binding.edit.text.toString(), binding.linkText.text.toString(), date, binding.onlineOrOffline.isChecked)
                            viewModel.save()
